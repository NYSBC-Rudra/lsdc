...
class MD2Device(GonioDevice):
    ...
    def send_3_click_command(self, click_points):
        ...
        self.three_click_omega_value = int(self.omega.get().readback)
    ...
    def start_3_click_center(self):
        ...
        self.md2_in_three_click_state = True
        self.three_click_omega_value = (int(self.omega.get().readback)-90)%360 # making it 90 degrees less to account for the first click not rotating the omega
